...
const ProductCardSkeleton = () => {
  return (
    <div className="bg-white flex flex-col h-full rounded-3xl border border-slate-100 overflow-hidden">
      ...
      <div className="flex flex-col flex-grow p-3 md:p-5 pt-4 space-y-3">
        ...
        <div className="w-full flex flex-col gap-2 md:gap-3 pt-2 md:pt-4 mt-auto">
          <Skeleton className="h-10 md:h-14 w-full rounded-xl md:rounded-2xl" />
          <Skeleton className="h-10 md:h-14 w-full rounded-xl md:rounded-2xl" />
        </div>
      </div>
    </div>
